...
class Test_source_code_simplifier(unittest.TestCase):
    def test_normalize(self):
        ...
        p = Program([Variable(2, Type.Int), Variable(0, Type.IntList)], [
                    (Variable(3, Type.Int), Expression(F, [Variable(2, Type.Int)]))])
        p = normalize(p)
        self.assertEqual(
            p,
            Program([Variable(0, Type.IntList), Variable(1, Type.Int)], [
                    (Variable(2, Type.Int), Expression(F, [Variable(1, Type.Int)]))])
        )
    ...
    def test_remove_redundant_variables(self):
        ...
        p = Program([Variable(0, Type.Int), Variable(1, Type.IntList)], [
                    (Variable(2, Type.Int), Expression(F, [Variable(0, Type.Int)]))])
        p = remove_redundant_variables(p)
        self.assertEqual(
            p,
        ...
        p = Program([Variable(0, Type.Int)], [(Variable(1, Type.Int), Expression(F, [Variable(
            0, Type.Int)])), (Variable(2, Type.Int), Expression(F, [Variable(0, Type.Int)]))])
        p = remove_redundant_variables(p)
        self.assertEqual(
            p,
            Program([Variable(0, Type.Int)], [
    ...
    def test_remove_redundant_expressions(self):
        ...
        p = Program([Variable(0, Type.IntList)], [
                    (Variable(1, Type.Int), Expression(F, [Variable(0, Type.IntList)]))])
        p = remove_redundant_expressions(p)
        self.assertEqual(p, Program([Variable(0, Type.IntList)], [
                         (Variable(1, Type.Int), Expression(F, [Variable(0, Type.IntList)]))]))

        p = Program([Variable(0, Type.IntList)], [
            (Variable(1, Type.IntList), Expression(
                SORT, [Variable(0, Type.IntList)])),
            (Variable(2, Type.IntList), Expression(
                SORT, [Variable(0, Type.IntList)])),
            (Variable(3, Type.IntList), Expression(
